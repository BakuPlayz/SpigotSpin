package dev.bakuplayz.spigotspin.abstraction.menu.menus;

import dev.bakuplayz.spigotspin.abstraction.menu.items.Item;
import dev.bakuplayz.spigotspin.abstraction.menu.items.paginated.CurrentPageItem;
import dev.bakuplayz.spigotspin.abstraction.menu.items.paginated.NextPageItem;
import dev.bakuplayz.spigotspin.abstraction.menu.items.paginated.PreviousPageItem;
import dev.bakuplayz.spigotspin.abstraction.menu.items.state.StateItem;
import dev.bakuplayz.spigotspin.abstraction.menu.menus.handlers.OpenInventoryHandler;
import dev.bakuplayz.spigotspin.abstraction.menu.menus.paginated.*;
import dev.bakuplayz.spigotspin.abstraction.menu.utils.Collection;
import dev.bakuplayz.spigotspin.abstraction.menu.utils.TypeUtils;
